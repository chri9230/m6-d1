...
function addCart(articolo, price) {
    ...
    contenitoreLi.innerHTML += 
    `
    <li id='art'>
     ${articolo} - ${price} € 
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16" onclick='elimina(event)'>
